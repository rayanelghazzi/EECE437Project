...
namespace HumanityService.Stores
{
    public class TransactionStore : ITransactionStore
    {
        ...
        public TransactionStore(ISqlConnectionFactory sqlConnectionFactory)
        {
            _sqlConnectionFactory = sqlConnectionFactory;
        }

        public Task AddCampaign(Campaign campaign)
        {
            throw new NotImplementedException();
        }

        public Task AddDeliveryDemand(DeliveryDemand deliveryDemand)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<DeliveryDemand> GetDeliveryDemand(string deliveryDemandId)
        {
            throw new NotImplementedException();
        }

        public Task<List<DeliveryDemand>> GetDeliveryDemands(GetDeliveryDemandsRequest request)
        {
            throw new NotImplementedException();
        }
