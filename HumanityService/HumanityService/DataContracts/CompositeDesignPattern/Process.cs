...
namespace HumanityService.DataContracts.CompositeDesignPattern
{
    public class Process : IComponent
    {
        ...
        public async Task ValidateContribution() 
        //For volunteer. Once a contribution is assigned, its status is updated to: InProgress.
        {
            Status = "InProgress";
            await Update();
        ...
        public async Task CompleteContribution()
        //For volunteer. Once a contribution is completed, its status is updated to: Completed.
        {
            Status = "Completed";
            await Update();
